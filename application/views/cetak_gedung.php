...
<head>
  ...
  <title>Admin GA | Laporan Kondisi Gedung</title>
...
<div class="wrapper">
  ...
  <section class="invoice">
	...
	<div class="col-xs-12 table-responsive">
	  ...
	  ?>
	  <h5>LAPORAN KONDISI GEDUNG PADA BULAN <?php echo $bulan.' TAHUN '.$datacetak->tahun ?></h5>
		  <?php break;}}?>
		  <br>
        <table class="table table-bordered">
          <thead>
          <tr>
            <th width="100px">Nama Ruangan</th>
            <th>Keadaan / Kondisi Ruangan</th>
            <th>Status</th>
            <th>Catatan GA</th>
            <th>Saran</th>
          </tr>
          ...
          <tr>
            ...
            <td width="100px"><?php echo $datacetak->Nama_Ruangan ?></td>
            <td><?php echo $datacetak->Kondisi_Ruangan ?></td>
            <td><?php echo $datacetak->Status_Ruangan ?></td>
            <td><?php echo $datacetak->Catatan_GA_Ruangan ?></td>
            <td><?php echo $datacetak->Saran_Ruangan ?></td>
          </tr>
		  <?php 
		  }
		  } else {
