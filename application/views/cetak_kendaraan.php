...
<head>
  ...
  <title>Admin GA | Laporan Kondisi Kendaraan</title>
...
<div class="wrapper">
  ...
  <section class="invoice">
	...
	<div class="col-xs-12 table-responsive">
	  ...
	  ?>
	  <h5>LAPORAN KONDISI KENDARAAN PADA BULAN <?php echo $bulan.' TAHUN '.$datacetak->tahun ?></h5>
		  <?php break;}}?>
		  <br>
      <div class="col-xs-12 table-responsive">
        <table class="table table-bordered">
          ...
          <tr>
			...
			<th colspan="5">Kondisi Kendaraan</th>
			<th rowspan="2">Catatan GA</th>
		  ...
		  foreach($cetak as $datacetak){?>
          <tr>
			<td><?php echo $datacetak->Nama_Kendaraan?></td>
			<td><?php echo $datacetak->Nomor_Polisi?></td>
			<td><?php echo $datacetak->Masa_Berlaku_STNK?></td>
			<td><?php echo $datacetak->Masa_Berlaku_Pajak?></td>
			<td><?php echo $datacetak->Kondisi_Badan_Kendaraan?></td>	
			<td><?php echo $datacetak->Kondisi_Ban_Kendaraan?></td>	
			<td><?php echo $datacetak->Kondisi_Interior_Kendaraan?></td>	
			<td><?php echo $datacetak->Kondisi_Mesin_Kendaraan?></td>	
			<td><?php echo $datacetak->Kondisi_Panel_Kendaraan?></td>	
			<td><?php echo $datacetak->Catatan_GA_Kendaraan?></td>								  
			<td><?php echo $datacetak->Saran_Kendaraan?></td>
          </tr>
		  <?php 
		  }
		  } else {
