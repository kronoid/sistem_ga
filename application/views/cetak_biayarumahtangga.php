...
<head>
  ...
  <title>Admin GA | Laporan Biaya Rumah Tangga</title>
...
<div class="wrapper">
  ...
  <section class="invoice">
	...
	<div class="col-xs-12 table-responsive">
	  ...
	  ?>
	  <h5>LAPORAN BIAYA RUMAH TANGGA PADA BULAN <?php echo $bulan.' TAHUN '.$datacetak->tahun ?></h5>
		  <?php break;}}?>
		  <br>
      <div class="col-xs-12 table-responsive">
        <table class="table table-bordered">
          ...
          <tr>
			...
			<th>Total Harga Pembayaran (Rp)</th>
          </tr>
          </thead>
          <tbody>
		  <?php 
          ...
          <tr>
            ...
            <td><?php echo date("d F Y", strtotime($datacetak->Tgl_Beli))?></td>
            <td class="text-right"><?php echo number_format($datacetak->Total_Harga,"2",",",".") ?></td>
		  </tr>
		  <?php
		  $total = $total+$datacetak->Total_Harga;
		  }
		  } else {
			echo "<tr>Data tidak tersedia</tr>";
		  }?>
		  <tr>
			  <td colspan="3" class="text-center">Total Pembayaran (Rp) :</td>
